...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
else
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_FSFiltersetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_FSFiltersetup.make
else
#cmt_local_setup = $(bin)FSFiltersetup$(cmt_lock_pid).make
...
$(cmt_local_tagfile_FSFilter) :
	...
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_FSFilter)"
	@if test -f $(cmt_local_tagfile_FSFilter); then /bin/rm -f $(cmt_local_tagfile_FSFilter); fi ; \
	  ...
	  if test -f $(cmt_final_setup_FSFilter); then /bin/rm -f $(cmt_final_setup_FSFilter); fi; \
	  $(cmtexe) -tag=$(tags) $(FSFilter_extratags) show setup >>$(cmt_final_setup_FSFilter)
	$(echo) setup.make ok
...
FSFilter :: $(FSFilter_dependencies) $(cmt_local_FSFilter_makefile)
	$(echo) "(constituents.make) Starting FSFilter"
	@$(MAKE) -f $(cmt_local_FSFilter_makefile) cmt_lock_pid=$${cmt_lock_pid} FSFilter
...
FSFilterclean :: $(FSFilterclean_dependencies) ##$(cmt_local_FSFilter_makefile)
	...
	@-if test -f $(cmt_local_FSFilter_makefile); then \
	  $(MAKE) -f $(cmt_local_FSFilter_makefile) cmt_lock_pid=$${cmt_lock_pid} FSFilterclean; \
	fi
...
FSFilterinstall :: $(FSFilter_dependencies) $(cmt_local_FSFilter_makefile)
	...
	@-$(MAKE) -f $(cmt_local_FSFilter_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install FSFilter done"

uninstall :: FSFilteruninstall

FSFilteruninstall :: $(cmt_local_FSFilter_makefile)
	$(echo) "(constituents.make) Starting uninstall FSFilter"
	@-$(MAKE) -f $(cmt_local_FSFilter_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
...
ifdef READONLY
cmt_local_tagfile_install_runtime = /tmp/CMT_$(FSFilter_tag)_install_runtime.make$(cmt_lock_pid)
cmt_final_setup_install_runtime = /tmp/CMT_FSFilter_install_runtimesetup.make
...
ifdef READONLY
cmt_local_tagfile_install_runtime = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_install_runtime = /tmp/CMT_FSFiltersetup.make
cmt_local_install_runtime_makefile = /tmp/CMT_install_runtime$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(FSFilter_tag)_config.make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_FSFilter_configsetup.make
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_FSFiltersetup.make
cmt_local_config_makefile = /tmp/CMT_config$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(FSFilter_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_FSFilter_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_FSFiltersetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(FSFilter_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_FSFilter_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_FSFiltersetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(FSFilter_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_FSFilter_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_FSFiltersetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(FSFilter_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_FSFilter_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_FSFiltersetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(FSFilter_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_FSFilter_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_FSFiltersetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(FSFilter_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_FSFilter_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_FSFiltersetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(FSFilter_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_FSFilter_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_FSFiltersetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(FSFilter_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_FSFilter_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_FSFiltersetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(FSFilter_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_FSFilter_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(FSFilter_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_FSFiltersetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
...
$(cmt_local_tagfile_FSFilter_check_install_runtime) :
	...
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_FSFilter_check_install_runtime)"
	@if test -f $(cmt_local_tagfile_FSFilter_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_FSFilter_check_install_runtime); fi ; \
	  ...
	  if test -f $(cmt_final_setup_FSFilter_check_install_runtime); then /bin/rm -f $(cmt_final_setup_FSFilter_check_install_runtime); fi; \
	  $(cmtexe) -tag=$(tags) $(FSFilter_check_install_runtime_extratags) show setup >>$(cmt_final_setup_FSFilter_check_install_runtime)
	$(echo) setup.make ok
...
FSFilter_check_install_runtime :: $(FSFilter_check_install_runtime_dependencies) $(cmt_local_FSFilter_check_install_runtime_makefile)
	$(echo) "(constituents.make) Creating FSFilter_check_install_runtime${lock_suffix} and Starting FSFilter_check_install_runtime"
	@${lock_command} FSFilter_check_install_runtime${lock_suffix} || exit $$?; \
	  retval=$$?; \
	  trap '${unlock_command} FSFilter_check_install_runtime${lock_suffix}; exit $${retval}' 1 2 15; \
	  $(MAKE) -f $(cmt_local_FSFilter_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} FSFilter_check_install_runtime; \
	  retval=$$?; ${unlock_command} FSFilter_check_install_runtime${lock_suffix}; exit $${retval}
...
FSFilter_check_install_runtimeclean :: $(FSFilter_check_install_runtimeclean_dependencies) ##$(cmt_local_FSFilter_check_install_runtime_makefile)
	...
	@-if test -f $(cmt_local_FSFilter_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_FSFilter_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} FSFilter_check_install_runtimeclean; \
	fi
...
FSFilter_check_install_runtimeinstall :: $(FSFilter_check_install_runtime_dependencies) $(cmt_local_FSFilter_check_install_runtime_makefile)
	...
	@-$(MAKE) -f $(cmt_local_FSFilter_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install FSFilter_check_install_runtime done"

uninstall :: FSFilter_check_install_runtimeuninstall

FSFilter_check_install_runtimeuninstall :: $(cmt_local_FSFilter_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall FSFilter_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_FSFilter_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
